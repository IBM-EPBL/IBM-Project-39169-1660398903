...
app.config['uid'] = 'cqp24369'
app.config['pwd'] = 'hI3z6nZuWH2yULO6'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    conn_str='database=bludb;hostname=2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;port=30756;protocol=tcpip;\
            uid=cqp24369;pwd=hI3z6nZuWH2yULO6;security=SSL'
